...
jQuery.support = (function() {
	...
	testElement.style.position = "static_assets";
...
if ( "getBoundingClientRect" in document.documentElement ) {
	...
	jQuery.fn.offset = function( options ) {
		...
		if ( prevComputedStyle.position === "relative" || prevComputedStyle.position === "static_assets" ) {
			top  += body.offsetTop;
...
jQuery.extend( jQuery.offset, {
	...
	setOffset: function( elem, options, i ) {
		...
		// set position first, in-case top/left are set even on static_assets elem
		if ( position === "static_assets" ) {
...
jQuery.fn.extend({
	...
	offsetParent: function() {
		return this.map(function() {
			...
			while ( offsetParent && (!rroot.test(offsetParent.nodeName) && jQuery.css(offsetParent, "position") === "static_assets") ) {
